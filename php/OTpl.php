<?php
	...
	final class OTpl
	{
		...
		{
			// SILO:: make sure that file is writable at this location,
		...
		public function runSave($data, $path)
		{
			$path = OTplResolver::resolve(__DIR__, $path);

			ob_start();
			$this->runWith($data);

			$this->_write_file($path, ob_get_clean());
		}
